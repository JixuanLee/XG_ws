...
static const int iterations = 10000000; //最大迭代次数
/// [m] --- Uniformly adds a padding around the vehicle
static const double bloating = 0.5; //膨胀范围
/// [m] --- The width of the vehicle
static const double width = 2.1 + 2 * bloating;//车的宽度
/// [m] --- The length of the vehicle
static const double length = 3.2 + 2 * bloating;//车的长度
/// [m] --- The minimum turning radius of the vehicle
static const float r = 5.4;//最小转弯半径
/// [m] --- The number of discretizations in heading
static const int headings = 12;//车体朝向的离散数量
...
static const float cellSize = 0.4; //在2D网格中cell的大小
/*!
 ...
 */
static const float tieBreaker = 0.1;
...
static const float dubinsStepSize = 5;
...
static const int dubinsWidth = 100;//Dubin搜索区域的宽度
