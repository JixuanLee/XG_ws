...
class Visualize {
 public:
  ...
  Visualize() : n("~")
  {
    ...
    {
      pubNode3D = n.advertise<geometry_msgs::PoseStamped>("visualizeNodes3DPose", 10);
      pubNodes3D = n.advertise<geometry_msgs::PoseArray>("visualizeNodes3DPoses", 10);
      pubNodes3Dreverse = n.advertise<geometry_msgs::PoseArray>("visualizeNodes3DPosesReverse", 10);
      pubNodes3DCosts = n.advertise<visualization_msgs::MarkerArray>("visualizeNodes3DCosts", 1, true);
    }
    
    if (Constants::visualization2D)
    {
      pubNode2D = n.advertise<geometry_msgs::PoseStamped>("visualizeNodes2DPose", 10);
      pubNodes2D = n.advertise<geometry_msgs::PoseArray>("visualizeNodes2DPoses", 10);
      pubNodes2DCosts = n.advertise<visualization_msgs::MarkerArray>("visualizeNodes2DCosts", 1, true);
    }
  ...
  void setMapOri(float x, float y){ori_x = x; ori_y = y;}//sjd
