...
extern const float historyKeyframeSearchRadius = 7.0; // ljx-2024-05-11: forXG 修改了，原始7.0，调大方便XG门口花坛处回环，。---我又改回去了。
...
extern const float historyKeyframeFitnessScore = 0.3; // the smaller the better alignment// ljx-2024-05-11: forXG 修改了，原始0.3，调大方便XG门口花坛处回环，。我又改回去了。

extern const float globalMapVisualizationSearchRadius = 9999.0; // key frames with in n meters will be visualized
